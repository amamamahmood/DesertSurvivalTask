...
export declare class Panel extends BaseVue {
    ...
    get rows(): import("survey-core").QuestionRowModel[];
    get hasTitle(): boolean;
    get survey(): ISurvey;
    get iconCss(): any;
    keyup(evt: any): void;
...
export declare class TitleActions extends Vue {
    ...
    css: any;
    constructor();
    get toolbar(): import("survey-core").AdaptiveActionContainer<import("survey-core").Action, import("survey-core").IAction>;
}
...
export declare class DragDropHelper extends Base {
    ...
    getItemValueGhostPosition(item: any): "bottom" | "top";
}
